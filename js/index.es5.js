...
// var nameNode = document.querySelector(".people__data").children[0];
// var positionNode = document.querySelector(".people__data").children[1];
...
//   Array.from(peoplesNode.children).forEach(function (node, index) {
//     node.classList.remove("people__img--active");

//     if (index > 2) node.classList.remove("people__img--active--small");
//   });
//   Array.from(buttonNode.children).forEach(function (node, index) {
...
//   if (currentActive > 2)
//     peoplesNode.children[currentActive].classList.add(
//       "people__img--active--small"
//     );
...
//   if (number > 2) {
//     peoplesNode.children[number].classList.add("people__img--active--small");
//   }
...
if (window.outerWidth > 1441) {
  ...
  line.style.width = "10000000000px";
...
function sendMail(e) {
  ...
  var params = {};
  params.name = document.querySelector(".contact__name").value;
  params.email = document.querySelector(".contact__email").value;
  params.phone = document.querySelector(".contact__company").value;
  params.budget = document.querySelector(".contact__budget").value;
  params.details = document.querySelector(".contact__details").value;

  console.log(params);

  emailjs.send("gmail", "template_hp6nicg", params).then(
    function (response) {
  ...
  contactBtn.innerHTML = "Thanks! We will contact you soon.";
  contactForm.reset();
}
...
// --------------------- Cookies --------------------
var cookiesAreAllowed = localStorage.getItem("cookiesAllowed");

if (!cookiesAreAllowed) {
  document.querySelector(".cookies").style.display = "flex";
}

var cookiesBtn = document.querySelector(".cookies__btn");
...
cookiesBtn.addEventListener("click", allowCookies);
